...
<html>
    ...
    <body>
        <div id="fb-root"></div>
        <script async defer crossorigin="anonymous" src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v5.0&appId=695593920924269&autoLogAppEvents=1"></script>
        ...
        <div class="container" style="margin-top: 5rem">
            <div class="row mt-5">
                ...
                <div class="col-md-6 pl-5">
                    ...
                    <p class="my-0"><b style="font-size: 25px;color: #f60">$ ${requestScope.product.price}</b><c:if test="${product.status eq 2}"><span class="ml-3" style="font-size: 20px; color: rgb(153, 153, 153)"><strike>$ ${Math.round(product.price*(1+product.sale)*100)/100}</strike></span></c:if></p>
                    <hr/>
                    <h6 class="mt-5"><b>Code of Product:  ${requestScope.product.code}</b></h6>
                    <hr/>
                    <p class="mt-4"><b>Infomation of Product:</b></br></br>${requestScope.product.description}</p>
                    <hr/>
                    <a href="add-to-cart?id=${requestScope.product.id}" class="btn btn-outline-danger w-50 mt-4"><i class="fas fa-cart-plus mr-2"></i>Add to Cart</a>
        ...
        <div class="fb-comments" data-href="http://localhost:8080/HousewareShop/detail?id=param.${product.id}" data-width="500px" data-numposts="10"></div>
