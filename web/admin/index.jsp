                ...
                <div class="container-fluid">
                        ...
                        <div class="col-xl-3 col-sm-6 mb-3">
                            <div class="card text-white bg-warning o-hidden h-100">
                                <div class="card-body">
                                    ...
                                    <div class="mr-5">${numProduct} Products</div>
                                </div>
                        ...
                        <div class="col-xl-3 col-sm-6 mb-3">
                            <div class="card text-white bg-success o-hidden h-100">
                                <div class="card-body">
                                    ...
                                    <div class="mr-5">${numAccount} Accounts</div>
                                </div>
                        ...
                        <div class="col-xl-3 col-sm-6 mb-3">
                            <div class="card text-white bg-danger o-hidden h-100">
                                <div class="card-body">
                                    ...
                                    <div class="mr-5">${numSubCategory} Categories</div>
                                </div>
                    ...
                    <div class="card mb-3">
                        <div class="card-header">
                            ...
                            Statistics of invoice numbers during the week</div>
                        <div class="card-body">
                    ...
                    <p class="small text-center text-muted my-5">
                        <em>More statistics is comming soon...</em>
                    </p>
