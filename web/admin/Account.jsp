                                ...
                                <table class="table table-bordered text-center" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="edit-account?user=${account.userName}" class="btn btn-outline-warning"><i class="fas fa-edit mr-2"></i>Edit</a></td>
                                            <td><a  href="delete-account?user=${account.userName}" onclick="return confirm('Are you sure you want to delete this item?');" class="btn btn-outline-danger"><i class="fas fa-trash mr-2"></i>Delete</a></td>                                        </tr>
                                        </c:forEach>
                                    </tbody>
                                </table>
                            </div>
