...
public class EditAccountController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            Account accountEdit = new AccountService().getOne(userName);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        Account accountOld = new AccountService().getOne(username);
        Account AccountCheckEmail = new AccountService().getOneByEmail(email);
        if (AccountCheckEmail!=null&&!AccountCheckEmail.getUserName().equals(accountOld.getUserName())) {
            ...
            boolean check = new AccountService().update(accountNew, username);
            if (!check) {
