            ...
            <c:choose>
                <c:when test="${sessionScope.listCart eq null || sessionScope.listCart.size()==0}">
                    <div class="text-center">
                        ...
                        <a href="get-list-product" class="btn btn-success mt-2">Quay lai</a>
                    </div>
                </c:when>
                <c:otherwise>
                    <div class="mt-3">
                        <h4>Giỏ hàng</h4>
                        <form id="formQuantity" action="sync-cart" method="get" onload="submitForm()">
                                ...
                                <table class="w-100 table table-striped mt-3">
                                    ...
                                    <c:forEach items="${sessionScope.listCart}" var="cart" varStatus="track">
                                        <tr>
                                            ...
                                            <td>
                                                <input type="number" min="1" max="${cart.productQuantity}" class="pl-1" name="quantity${track.count}" value="${cart.quantity}" style="width: 60px"/>
                                            </td>
                                            <td>
                            ...
                            <hr/>
                            <div class="text-right">
                                <a href="remove-product?flag=0" class="btn btn-danger"><i class="fas fa-trash mr-2"></i>Delete Cart</a>
