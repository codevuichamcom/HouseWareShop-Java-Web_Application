                        ...
                        <div class="alert alert-secondary" role="alert">
                            <form onchange="submitForm()" id="combo" action="sort-product" method="post">List of products
                                ...
                                <select name="price" style="font-size: 1rem">
                                    ...
                                    <a href="sort-product?name=1" style="color: orange"><i class="fas fa-sort ml-5"></i></a>
                                </form>
                            </div>
                                    <%@include file="../component/navPaging.jsp" %>
                            <div class="row mb-5">
                                        ...
                                        <div class="col-md-3 mt-4 pt-2">
                                            <div class="card">
                                                <c:if test="${product.status==2}">
                                                    <div id="DIV_1">
                                                        <span id="SPAN_2">${Math.round(product.sale*100)}</span>
                                                    </div>
                                                </c:if>
                                                ...
                                                <div class="card-body pt-3">
                                                    <a href="add-to-cart-now?id=${product.id}" class="btn btn-outline-danger"><i class="fas fa-cart-plus mr-2"></i>Add to cart</a>
